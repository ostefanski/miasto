    ...
    >
      ...
      <List className="list">
        {initCategoriesForMenuList.map((category) => {
          ...
          const sortedCategoryMarkers = [...categoryMarkers].sort(
            ...
            <React.Fragment key={category}>
              <ListItem disablePadding>
                <ListItemButton onClick={() => toggleCategory(category)}>
                  {matchedCategory && (
                    <ListItemIcon>{matchedCategory.icon}</ListItemIcon>
                  )}
                  <ListItemText
                    primary={
                      <>
              ...
              <Collapse
                in={stateCategory.categoryOpen[category]}
                timeout="auto"
                unmountOnExit
              >
                {/* Expandable content */}
                        ...
                        onClick={() => {
                          ...
                          if (selectedDirection) {
                            setShowPlaceInfo((prevInfo) => ({
                              ...
                              formattedAddress:
                                selectedDirection.formattedAddress,
                          ...
                          if (selectedDirection) {
                            directionsRenderinstance.current?.setDirections(
